...
describe('FreshUrl', function() {
  ...
  describe('the whole enchilada', function() {
    beforeEach(function() {
      ...
      dirtyUrl = "" + this.cleanPath + "?utm_medium=specs&utm_source=jasmine";
  ...
  return describe('#cleanedSearch', function() {
    var expectClean, f;
    f = new FreshUrl();
    ...
    return it('wipes everything if there are only utm params', function() {
